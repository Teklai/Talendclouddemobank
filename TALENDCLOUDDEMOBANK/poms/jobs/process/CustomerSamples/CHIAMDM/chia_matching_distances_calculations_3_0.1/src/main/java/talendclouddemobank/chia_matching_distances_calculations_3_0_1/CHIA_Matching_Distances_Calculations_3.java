...
package talendclouddemobank.chia_matching_distances_calculations_3_0_1;
...
/**
 * Job: CHIA_Matching_Distances_Calculations_3 Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class CHIA_Matching_Distances_Calculations_3 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "CHIA_Matching_Distances_Calculations_3.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(CHIA_Matching_Distances_Calculations_3.class);
	...
	private final String jobName = "CHIA_Matching_Distances_Calculations_3";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				CHIA_Matching_Distances_Calculations_3.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CHIA_Matching_Distances_Calculations_3.this,
	...
	public static class PossibleMatchesOutputStruct
		...
		final static byte[] commonByteArrayLock_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3 = new byte[0];
		static byte[] commonByteArray_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3 = new byte[0];
		...
		public Integer SNNSCORE;

		public Integer getSNNSCORE() {
			return this.SNNSCORE;
		}

		public Boolean SNNSCOREIsNullable() {
			return true;
		}

		public Boolean SNNSCOREIsKey() {
			return false;
		}

		public Integer SNNSCORELength() {
			return null;
		}

		public Integer SNNSCOREPrecision() {
			return null;
		}

		public String SNNSCOREDefault() {

			return null;

		}

		public String SNNSCOREComment() {

			return "";

		}

		public String SNNSCOREPattern() {

			return "";

		}

		public String SNNSCOREOriginalDbColumnName() {

			return "SNNSCORE";

		}

		public Integer BirthdaySCORE;

		public Integer getBirthdaySCORE() {
			return this.BirthdaySCORE;
		}

		public Boolean BirthdaySCOREIsNullable() {
			return true;
		}

		public Boolean BirthdaySCOREIsKey() {
			return false;
		}

		public Integer BirthdaySCORELength() {
			return null;
		}

		public Integer BirthdaySCOREPrecision() {
			return null;
		}

		public String BirthdaySCOREDefault() {

			return null;

		}

		public String BirthdaySCOREComment() {

			return "";

		}

		public String BirthdaySCOREPattern() {

			return "";

		}

		public String BirthdaySCOREOriginalDbColumnName() {
		...
		public String SSN_BlockingKey;

		public String getSSN_BlockingKey() {
			return this.SSN_BlockingKey;
		}

		public Boolean SSN_BlockingKeyIsNullable() {
			return true;
		}

		public Boolean SSN_BlockingKeyIsKey() {
			return false;
		}

		public Integer SSN_BlockingKeyLength() {
			return 20;
		}

		public Integer SSN_BlockingKeyPrecision() {
			return 0;
		}

		public String SSN_BlockingKeyDefault() {

			return null;

		}

		public String SSN_BlockingKeyComment() {

			return "";

		}

		public String SSN_BlockingKeyPattern() {

			return "";

		}

		public String SSN_BlockingKeyOriginalDbColumnName() {

			return "SSN_BlockingKey";
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3.length) {
					if (length < 1024
							&& commonByteArray_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3.length == 0) {
						commonByteArray_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3 = new byte[1024];
					} else {
						commonByteArray_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3 = new byte[2
								* length];
					}
				}
				dis.readFully(commonByteArray_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3, 0, length);
				strReturn = new String(commonByteArray_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3, 0,
						length);
				strReturn = new String(commonByteArray_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3, 0,
						length, utf8Charset);
			}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDCLOUDDEMOBANK_CHIA_Matching_Distances_Calculations_3) {
				...
				try {
					...
					this.SNNSCORE = readInteger(dis);

					this.BirthdaySCORE = readInteger(dis);

					this.GENDERSCORE = readInteger(dis);

					this.SSN_BlockingKey = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.SNNSCORE, dos);

				// Integer

				writeInteger(this.BirthdaySCORE, dos);
				...
				writeString(this.SSN_BlockingKey, dos);
		...
		public String toString() {
			...
			sb.append(",SNNSCORE=" + String.valueOf(SNNSCORE));
			sb.append(",BirthdaySCORE=" + String.valueOf(BirthdaySCORE));
			sb.append(",GENDERSCORE=" + String.valueOf(GENDERSCORE));
			sb.append(",SSN_BlockingKey=" + SSN_BlockingKey);
		...
		public String toLogString() {
			...
			if (BirthdaySCORE == null) {
				sb.append("<null>");
			} else {
				sb.append(BirthdaySCORE);
			}
			...
			if (SSN_BlockingKey == null) {
				sb.append("<null>");
			} else {
				sb.append(SSN_BlockingKey);
			}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (enableLogStash) {
					talendJobLog.addCM("tLogRow_1", "<b>Matches Distances</b>", "tLogRow");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				class Util_tLogRow_1 {
					...
					public StringBuilder format() {
						...
						sb.append("|");
						int k = 0;
						for (k = 0; k < (totals + 39 - name.length()) / 2; k++) {
							sb.append(' ');
						}
						sb.append(name);
						for (int i = 0; i < totals + 39 - name.length() - k; i++) {
							sb.append(' ');
						}
						sb.append("|\n");
					...
					private StringBuilder print(String[] fillChars) {
						...
						// last column
						for (int i = 0; i < colLengths[39] - fillChars[1].length() + 1; i++) {
							sb.append(fillChars[2]);
						}
				...
				util_tLogRow_1.setTableName("<b>Matches Distances</b>");
				util_tLogRow_1.addRow(new String[] { "FirstName", "LastName", "Gender", "PatientAddress", "City",
						...
						"TargetHealthPlanID", "TargetMRN", "MATCHINGDISTANCES", "MATCHINGWEIGHT", "SNNSCORE",
						"BirthdaySCORE", "GENDERSCORE", "SSN_BlockingKey", "FNDOBBlockingKey", "LNPCBlockingKey",
...
///////////////////////    			
				...
				if (enableLogStash) {
					talendJobLog.addCM("tMap_1", "<b>Mapping</b>", "tMap");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
...
// # Lookup's keys initialization
				int count_PossibleMatches_tMap_1 = 0;
...
// # Outputs initialization
				int count_PossibleMatchesOutput_tMap_1 = 0;
...
// ###############################
				...
				if (enableLogStash) {
					talendJobLog.addCM("tRecordMatching_1", "<b>Record Matching</b>", "tRecordMatching");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				arrMatchHandleNull_tRecordMatching_1[0] = org.talend.dataquality.record.linkage.attribute.IAttributeMatcher.NullOption.nullMatchNull;
				...
				arrMatchHandleNull_tRecordMatching_1[1] = org.talend.dataquality.record.linkage.attribute.IAttributeMatcher.NullOption.nullMatchNull;
				...
				arrMatchHandleNull_tRecordMatching_1[2] = org.talend.dataquality.record.linkage.attribute.IAttributeMatcher.NullOption.nullMatchNull;
				...
				arrMatchHandleNull_tRecordMatching_1[3] = org.talend.dataquality.record.linkage.attribute.IAttributeMatcher.NullOption.nullMatchNull;
				...
				arrMatchHandleNull_tRecordMatching_1[4] = org.talend.dataquality.record.linkage.attribute.IAttributeMatcher.NullOption.nullMatchNull;
				...
				arrMatchHandleNull_tRecordMatching_1[5] = org.talend.dataquality.record.linkage.attribute.IAttributeMatcher.NullOption.nullMatchNull;
				...
				arrMatchHandleNull_tRecordMatching_1[6] = org.talend.dataquality.record.linkage.attribute.IAttributeMatcher.NullOption.nullMatchNull;
				...
				arrMatchHandleNull_tRecordMatching_1[7] = org.talend.dataquality.record.linkage.attribute.IAttributeMatcher.NullOption.nullMatchNull;
					...
					class BytesLimit65535_tDBInput_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v2:UOBveYS6kl5vhPEeCCiI0h5Cr/DfSkMQ1Obg2tltczGjurGqeA==")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_3.append(" | ");
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v2:TiA8DDLCv25ebgFGJL6mrLyaN1rmUyaKy7YiXARtPcb3cg0X4Q==");
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "Source", "tDBInput_3", "<b>Data Source</b>", "tMysqlInput", "tRecordMatching_1",
								"<b>Record Matching</b>", "tRecordMatching"
						...
						arrMainData_tRecordMatching_1[0] = Source.SSN == null ? null : String.valueOf(Source.SSN);

						arrMainData_tRecordMatching_1[1] = FormatterUtils.format_Date(Source.Birthday, "dd-MM-yyyy");

						// not primitive type case
						arrMainData_tRecordMatching_1[2] = Source.Gender == null ? null : String.valueOf(Source.Gender);

						// not primitive type case
						arrMainData_tRecordMatching_1[3] = Source.PostalCode == null ? null
								: String.valueOf(Source.PostalCode);

						// not primitive type case
						arrMainData_tRecordMatching_1[4] = Source.HPLNID == null ? null : String.valueOf(Source.HPLNID);

						// not primitive type case
						arrMainData_tRecordMatching_1[5] = Source.FirstName == null ? null
								: String.valueOf(Source.FirstName);

						// not primitive type case
						arrMainData_tRecordMatching_1[6] = Source.LastName == null ? null
								: String.valueOf(Source.LastName);

						// not primitive type case
						arrMainData_tRecordMatching_1[7] = Source.PatientAddress == null ? null
						...
						while (tHash_Target.hasNext() || forceLoopTarget) {
							...
							if (bPMatch_tRecordMatching_1) {
								...
								PossibleMatches.MATCHING_DISTANCES = sMatchingDists_tRecordMatching_1;
								PossibleMatches.MATCHING_WEIGHT = matchingProba_tRecordMatching_1;
...
// Start of branch "PossibleMatches"
							if (PossibleMatches != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "PossibleMatches", "tRecordMatching_1", "<b>Record Matching</b>",
										"tRecordMatching", "tMap_1", "<b>Mapping</b>", "tMap"
								...
								{ // start of Var scope
									...
									Var.SSN_Score = PossibleMatches.SSN == null || PossibleMatches.TargetSSN == null
											? -750
											: Integer.parseInt(PossibleMatches.MATCHING_DISTANCES.substring(0, 1)) == 1
													? 650
													: -750;
									Var.DOB_Score = PossibleMatches.Birthday == null
											|| PossibleMatches.TargetBirthday == null
													? 0
													: Integer.parseInt(
															PossibleMatches.MATCHING_DISTANCES.substring(4, 5)) == 1
																	? 650
																	: -650;
									Var.GENDER_Score = PossibleMatches.Gender == null
											|| PossibleMatches.TargetGender == null
													? 0
													: Integer.parseInt(
															PossibleMatches.MATCHING_DISTANCES.substring(8, 9)) == 1
																	? 500
																	: -300;// ###############################
									// ###############################
									// # Output tables
...
// # Output table : 'PossibleMatchesOutput'
									count_PossibleMatchesOutput_tMap_1++;
									...
									PossibleMatchesOutput_tmp.SNNSCORE = Var.SSN_Score;
									PossibleMatchesOutput_tmp.BirthdaySCORE = Var.DOB_Score;
									PossibleMatchesOutput_tmp.GENDERSCORE = Var.GENDER_Score;
									PossibleMatchesOutput_tmp.SSN_BlockingKey = PossibleMatches.SSNBlockingKey;
									...
									log.debug("tMap_1 - Outputting the record " + count_PossibleMatchesOutput_tMap_1
...
// Start of branch "PossibleMatchesOutput"
								if (PossibleMatchesOutput != null) {
									...
									if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
											...
											, "PossibleMatchesOutput", "tMap_1", "<b>Mapping</b>", "tMap", "tLogRow_1",
...
///////////////////////		
									...
									String[] row_tLogRow_1 = new String[40];

									if (PossibleMatchesOutput.FirstName != null) { //
										row_tLogRow_1[0] = String.valueOf(PossibleMatchesOutput.FirstName);

									} //

									if (PossibleMatchesOutput.LastName != null) { //
										row_tLogRow_1[1] = String.valueOf(PossibleMatchesOutput.LastName);

									} //

									if (PossibleMatchesOutput.Gender != null) { //
										row_tLogRow_1[2] = String.valueOf(PossibleMatchesOutput.Gender);

									} //

									if (PossibleMatchesOutput.PatientAddress != null) { //
										row_tLogRow_1[3] = String.valueOf(PossibleMatchesOutput.PatientAddress);

									} //

									if (PossibleMatchesOutput.City != null) { //
										row_tLogRow_1[4] = String.valueOf(PossibleMatchesOutput.City);

									} //

									if (PossibleMatchesOutput.State != null) { //
										row_tLogRow_1[5] = String.valueOf(PossibleMatchesOutput.State);

									} //

									if (PossibleMatchesOutput.PostalCode != null) { //
										row_tLogRow_1[6] = String.valueOf(PossibleMatchesOutput.PostalCode);

									} //

									if (PossibleMatchesOutput.Birthday != null) { //
										row_tLogRow_1[7] = FormatterUtils.format_Date(PossibleMatchesOutput.Birthday,
												"yyyy-MM-dd");

									} //

									if (PossibleMatchesOutput.SSN != null) { //
										row_tLogRow_1[8] = String.valueOf(PossibleMatchesOutput.SSN);

									} //

									if (PossibleMatchesOutput.HPLNID != null) { //
										row_tLogRow_1[9] = String.valueOf(PossibleMatchesOutput.HPLNID);

									} //

									if (PossibleMatchesOutput.NYSIISFirstName != null) { //
										row_tLogRow_1[10] = String.valueOf(PossibleMatchesOutput.NYSIISFirstName);

									} //

									if (PossibleMatchesOutput.NYSIISLastName != null) { //
										row_tLogRow_1[11] = String.valueOf(PossibleMatchesOutput.NYSIISLastName);

									} //

									if (PossibleMatchesOutput.HealthPlanID != null) { //
										row_tLogRow_1[12] = String.valueOf(PossibleMatchesOutput.HealthPlanID);

									} //

									if (PossibleMatchesOutput.MRN != null) { //
										row_tLogRow_1[13] = String.valueOf(PossibleMatchesOutput.MRN);

									} //

									if (PossibleMatchesOutput.TargetFirstName != null) { //
										row_tLogRow_1[14] = String.valueOf(PossibleMatchesOutput.TargetFirstName);

									} //

									if (PossibleMatchesOutput.TargetLastName != null) { //
										row_tLogRow_1[15] = String.valueOf(PossibleMatchesOutput.TargetLastName);

									} //

									if (PossibleMatchesOutput.TargetGender != null) { //
										row_tLogRow_1[16] = String.valueOf(PossibleMatchesOutput.TargetGender);

									} //

									if (PossibleMatchesOutput.TargetPatientAddress != null) { //
										row_tLogRow_1[17] = String.valueOf(PossibleMatchesOutput.TargetPatientAddress);

									} //

									if (PossibleMatchesOutput.TargetCity != null) { //
										row_tLogRow_1[18] = String.valueOf(PossibleMatchesOutput.TargetCity);

									} //

									if (PossibleMatchesOutput.TargetState != null) { //
										row_tLogRow_1[19] = String.valueOf(PossibleMatchesOutput.TargetState);

									} //

									if (PossibleMatchesOutput.TargetPostalCode != null) { //
										row_tLogRow_1[20] = String.valueOf(PossibleMatchesOutput.TargetPostalCode);

									} //

									if (PossibleMatchesOutput.TargetBirthday != null) { //
										row_tLogRow_1[21] = FormatterUtils
												.format_Date(PossibleMatchesOutput.TargetBirthday, "yyyy-MM-dd");

									} //

									if (PossibleMatchesOutput.TargetSSN != null) { //
										row_tLogRow_1[22] = String.valueOf(PossibleMatchesOutput.TargetSSN);

									} //

									if (PossibleMatchesOutput.TargetHPLNID != null) { //
										row_tLogRow_1[23] = String.valueOf(PossibleMatchesOutput.TargetHPLNID);

									} //

									if (PossibleMatchesOutput.TargetNYSIISFirstName != null) { //
										row_tLogRow_1[24] = String.valueOf(PossibleMatchesOutput.TargetNYSIISFirstName);

									} //

									if (PossibleMatchesOutput.TargetNYSIISLastName != null) { //
										row_tLogRow_1[25] = String.valueOf(PossibleMatchesOutput.TargetNYSIISLastName);

									} //

									if (PossibleMatchesOutput.TargetHealthPlanID != null) { //
										row_tLogRow_1[26] = String.valueOf(PossibleMatchesOutput.TargetHealthPlanID);

									} //

									if (PossibleMatchesOutput.TargetMRN != null) { //
										row_tLogRow_1[27] = String.valueOf(PossibleMatchesOutput.TargetMRN);

									} //

									if (PossibleMatchesOutput.MATCHINGDISTANCES != null) { //
										row_tLogRow_1[28] = String.valueOf(PossibleMatchesOutput.MATCHINGDISTANCES);

									} //

									if (PossibleMatchesOutput.MATCHINGWEIGHT != null) { //
										row_tLogRow_1[29] = FormatterUtils
												.formatUnwithE(PossibleMatchesOutput.MATCHINGWEIGHT);

									} //

									if (PossibleMatchesOutput.SNNSCORE != null) { //
										row_tLogRow_1[30] = String.valueOf(PossibleMatchesOutput.SNNSCORE);

									} //

									if (PossibleMatchesOutput.BirthdaySCORE != null) { //
										row_tLogRow_1[31] = String.valueOf(PossibleMatchesOutput.BirthdaySCORE);

									} //

									if (PossibleMatchesOutput.GENDERSCORE != null) { //
										row_tLogRow_1[32] = String.valueOf(PossibleMatchesOutput.GENDERSCORE);

									} //

									if (PossibleMatchesOutput.SSN_BlockingKey != null) { //
										row_tLogRow_1[33] = String.valueOf(PossibleMatchesOutput.SSN_BlockingKey);

									} //

									if (PossibleMatchesOutput.FNDOBBlockingKey != null) { //
										row_tLogRow_1[34] = String.valueOf(PossibleMatchesOutput.FNDOBBlockingKey);

									} //

									if (PossibleMatchesOutput.LNPCBlockingKey != null) { //
										row_tLogRow_1[35] = String.valueOf(PossibleMatchesOutput.LNPCBlockingKey);

									} //

									if (PossibleMatchesOutput.NYSIISFNLNBlockingKey != null) { //
										row_tLogRow_1[36] = String.valueOf(PossibleMatchesOutput.NYSIISFNLNBlockingKey);

									} //

									if (PossibleMatchesOutput.DOBPCBlockingKey != null) { //
										row_tLogRow_1[37] = String.valueOf(PossibleMatchesOutput.DOBPCBlockingKey);

									} //

									if (PossibleMatchesOutput.MRNBlockingKey != null) { //
										row_tLogRow_1[38] = String.valueOf(PossibleMatchesOutput.MRNBlockingKey);
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "Source", 2, 0,
						...
						"<b>Record Matching</b>", "tRecordMatching", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'PossibleMatchesOutput': "
						+ count_PossibleMatchesOutput_tMap_1 + ".");

				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "PossibleMatches", 2, 0,
						"tRecordMatching_1", "<b>Record Matching</b>", "tRecordMatching", "tMap_1", "<b>Mapping</b>",
						"tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "PossibleMatchesOutput",
						2, 0, "tMap_1", "<b>Mapping</b>", "tMap", "tLogRow_1", "<b>Matches Distances</b>", "tLogRow",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBInput_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_5 - inputs:(after_tDBInput_3) outputs:(Target,Target) |
				// target node:tAdvancedHash_Target - inputs:(Target) outputs:()
				// linked node: tRecordMatching_1 - inputs:(Source,Target)
					...
					class BytesLimit65535_tDBInput_5 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_5.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v2:UnCzYZXkrfr287lzSzTXwDkP5hiuiORLOetRK4mitvLYjS9Jfw==")
									.substring(0, 4) + "...");
							log4jParamters_tDBInput_5.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_5", "<b>Reference Source</b>", "tMysqlInput");
					talendJobLogProcess(globalMap);
					s(currentComponent);
				}
				...
				final String decryptedPassword_tDBInput_5 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v2:VMGV7riAq4y5cOESfvPhW67UFp8W1EIP2wK3UcBfCxj84VJASQ==");
				...
				try {
					...
					while (rs_tDBInput_5.next()) {
						...
						if (colQtyInRs_tDBInput_5 < 1) {
							...
							Target.TargetFirstName = routines.system.JDBCUtil.getString(rs_tDBInput_5, 1, false);
						}
						if (colQtyInRs_tDBInput_5 < 2) {
							Target.TargetLastName = null;
						} else {

							Target.TargetLastName = routines.system.JDBCUtil.getString(rs_tDBInput_5, 2, false);
						}
						if (colQtyInRs_tDBInput_5 < 3) {
							Target.TargetGender = null;
						} else {

							Target.TargetGender = routines.system.JDBCUtil.getString(rs_tDBInput_5, 3, false);
						}
						if (colQtyInRs_tDBInput_5 < 4) {
							Target.TargetPatientAddress = null;
						} else {

							Target.TargetPatientAddress = routines.system.JDBCUtil.getString(rs_tDBInput_5, 4, false);
						}
						if (colQtyInRs_tDBInput_5 < 5) {
							Target.TargetCity = null;
						} else {

							Target.TargetCity = routines.system.JDBCUtil.getString(rs_tDBInput_5, 5, false);
						}
						if (colQtyInRs_tDBInput_5 < 6) {
							Target.TargetState = null;
						} else {

							Target.TargetState = routines.system.JDBCUtil.getString(rs_tDBInput_5, 6, false);
						}
						if (colQtyInRs_tDBInput_5 < 7) {
							Target.TargetPostalCode = null;
						} else {

							Target.TargetPostalCode = rs_tDBInput_5.getInt(7);
						...
						if (colQtyInRs_tDBInput_5 < 8) {
							...
							if (rs_tDBInput_5.getString(8) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_5)
									...
									Target.TargetBirthday = rs_tDBInput_5.getTimestamp(8);
								} else {
									Target.TargetBirthday = (java.util.Date) year0_tDBInput_5.clone();
								}
							} else {
								Target.TargetBirthday = null;
							}
						...
						if (colQtyInRs_tDBInput_5 < 9) {
							...
							Target.TargetSSN = routines.system.JDBCUtil.getString(rs_tDBInput_5, 9, false);
						}
						if (colQtyInRs_tDBInput_5 < 10) {
							Target.TargetHPLNID = null;
						} else {

							Target.TargetHPLNID = rs_tDBInput_5.getInt(10);
							if (rs_tDBInput_5.wasNull()) {
								Target.TargetHPLNID = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 11) {
							...
							Target.TargetNYSIISFirstName = routines.system.JDBCUtil.getString(rs_tDBInput_5, 11, false);
						}
						if (colQtyInRs_tDBInput_5 < 12) {
							Target.TargetNYSIISLastName = null;
						} else {

							Target.TargetNYSIISLastName = routines.system.JDBCUtil.getString(rs_tDBInput_5, 12, false);
						}
						if (colQtyInRs_tDBInput_5 < 13) {
							Target.TargetHealthPlanID = null;
						} else {

							Target.TargetHealthPlanID = routines.system.JDBCUtil.getString(rs_tDBInput_5, 13, false);
						}
						if (colQtyInRs_tDBInput_5 < 14) {
							Target.TargetMRN = null;
						} else {

							Target.TargetMRN = rs_tDBInput_5.getInt(14);
							if (rs_tDBInput_5.wasNull()) {
								Target.TargetMRN = null;
							}
						}
						if (colQtyInRs_tDBInput_5 < 15) {
							...
							Target.SSNBlockingKey = routines.system.JDBCUtil.getString(rs_tDBInput_5, 15, false);
						}
						if (colQtyInRs_tDBInput_5 < 16) {
							Target.FNDOBBlockingKey = null;
						} else {

							Target.FNDOBBlockingKey = routines.system.JDBCUtil.getString(rs_tDBInput_5, 16, false);
						}
						if (colQtyInRs_tDBInput_5 < 17) {
							Target.LNPCBlockingKey = null;
						} else {

							Target.LNPCBlockingKey = routines.system.JDBCUtil.getString(rs_tDBInput_5, 17, false);
						}
						if (colQtyInRs_tDBInput_5 < 18) {
							Target.NYSIISFNLNBlockingKey = null;
						} else {

							Target.NYSIISFNLNBlockingKey = routines.system.JDBCUtil.getString(rs_tDBInput_5, 18, false);
						}
						if (colQtyInRs_tDBInput_5 < 19) {
							Target.DOBPCBlockingKey = null;
						} else {

							Target.DOBPCBlockingKey = routines.system.JDBCUtil.getString(rs_tDBInput_5, 19, false);
						}
						if (colQtyInRs_tDBInput_5 < 20) {
							Target.MRNBlockingKey = null;
						} else {

							Target.MRNBlockingKey = routines.system.JDBCUtil.getString(rs_tDBInput_5, 20, false);
						}
						if (colQtyInRs_tDBInput_5 < 21) {
							Target.HealthPlanIDBlockingKey = null;
						} else {

							Target.HealthPlanIDBlockingKey = routines.system.JDBCUtil.getString(rs_tDBInput_5, 21,
									false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "Target", "tDBInput_5", "<b>Reference Source</b>", "tMysqlInput",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "Target", 2, 0,
						"tDBInput_5", "<b>Reference Source</b>", "tMysqlInput", "tAdvancedHash_Target",
	...
	public static void main(String[] args) {
		final CHIA_Matching_Distances_Calculations_3 CHIA_Matching_Distances_Calculations_3Class = new CHIA_Matching_Distances_Calculations_3();

		int exitCode = CHIA_Matching_Distances_Calculations_3Class.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'CHIA_Matching_Distances_Calculations_3' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'CHIA_Matching_Distances_Calculations_3' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_b3WioLyEEe-ILekM8jCPpA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-07-20T22:54:49.375216Z");
		...
		try {
			...
			java.io.InputStream inContext = CHIA_Matching_Distances_Calculations_3.class.getClassLoader()
					.getResourceAsStream("talendclouddemobank/chia_matching_distances_calculations_3_0_1/contexts/"
							+ contextStr + ".properties");
			if (inContext == null) {
				inContext = CHIA_Matching_Distances_Calculations_3.class.getClassLoader()
		...
		log.info("TalendJob: 'CHIA_Matching_Distances_Calculations_3' - Started.");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : CHIA_Matching_Distances_Calculations_3");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'CHIA_Matching_Distances_Calculations_3' - Finished - status: " + status + " returnCode: "
				+ returnCode);
...
/************************************************************************************************
 * 399088 characters generated by Talend Cloud Data Fabric on the July 20, 2025
 * at 6:54:49 PM EDT
 ************************************************************************************************/